...
func TestSelectionSorterCallsSwapperAndReturnsCorrectCount(t *testing.T) {
	...
	for _, test := range tests {
		...
		var sorter list.Sorter = list.NewSorter("selection", &list.LessThan{}, &list.SimpleAssigner{}, swapper, &list.NoPrint{})
...
func TestSelectionSorterCallsComparerAndReturnsCorrectCount(t *testing.T) {
	...
	for _, test := range tests {
		...
		var sorter list.Sorter = list.NewSorter("selection", comparer, &list.SimpleAssigner{}, &list.SimpleSwapper{}, &list.NoPrint{})
		sorter.Sort(test.input)
...
func TestSelectionSorterNeverCallsAssigner(t *testing.T) {
	...
	var sorter list.Sorter = list.NewSorter("selection", &list.LessThan{}, assigner, &list.SimpleSwapper{}, &list.NoPrint{})
...
func TestSelectionSorter(t *testing.T) {
	var sorter list.Sorter = list.NewSorter("selection", &list.LessThan{}, &list.SimpleAssigner{}, &list.SimpleSwapper{}, &list.NoPrint{})
	testSorters(t, sorter)
}

func TestInsertionSorter(t *testing.T) {
	var sorter list.Sorter = list.NewSorter("insertion", &list.LessThan{}, &list.SimpleAssigner{}, &list.SimpleSwapper{}, &list.NoPrint{})
	testSorters(t, sorter)
}

func TestMergeSorter(t *testing.T) {
	var sorter list.Sorter = list.NewSorter("merge", &list.LessThan{}, &list.SimpleAssigner{}, &list.SimpleSwapper{}, &list.NoPrint{})
	testSorters(t, sorter)
}

func TestParallelMergeSorter(t *testing.T) {
	var sorter list.Sorter = list.NewSorter("parallel_merge", &list.LessThan{}, &list.SimpleAssigner{}, &list.SimpleSwapper{}, &list.NoPrint{})
	testSorters(t, sorter)
}
